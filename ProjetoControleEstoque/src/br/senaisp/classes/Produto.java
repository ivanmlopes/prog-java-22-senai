...
public class Produto {
	...
	public boolean create () {
		...
		try {
			conn.conectarBD();
			String sql = "insert into produtos (descricao, saldo, preco, local_estoque) value (?,?,?,?)";
	...
	public boolean read () {
		...
		try {
			conn.conectarBD();
			String sql = "Select descricao, saldo, preco, local_estoque from produtos where id = ?";
	...
	public boolean delete () {
		...
		try {
			...
			int rowsAff = stmt.executeUpdate();
			//log
			System.out.println("Linha excluidas: " + rowsAff);
			conn.desconectarBD();
			ret=true;
	...
	public DefaultTableModel getListaProdutos () {
		...
		try {
			conn.conectarBD();
			String sql = "select id, descricao, saldo, preco, local_estoque from produtos order by id";
			PreparedStatement stmt = conn.getConector().prepareStatement(sql);
			ResultSet rs = stmt.executeQuery();
